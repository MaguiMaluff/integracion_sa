...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '39ab844e-b556-437a-9207-66e59d2f88c6' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c2cc4eef-8335-40f5-bf11-d5b6cb9c25f7');
      cy.get(`[data-cy="name"]`).should('have.value', 'c2cc4eef-8335-40f5-bf11-d5b6cb9c25f7');
